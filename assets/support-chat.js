(() => {
  ...
  function mount() {
    ...
    function toggle(force){const open=typeof force==="boolean"?force:panel.hidden;panel.hidden=!open;launcher.setAttribute("aria-expanded",String(open));document.documentElement.classList.toggle("ts-support-open",open);if(open){render();input.focus();}}
